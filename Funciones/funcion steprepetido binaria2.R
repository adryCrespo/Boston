...
#Los datos training han sido balanceados con el metodo ROSE
#Linea 26

steprepetidobinaria2<- function(data=data,vardep="vardep",
  listconti="listconti",
...
#aqui es donde he introducido el cambio
f<- formula(paste0(vardep,"~."))
train <- ROSE(f,data = data[sample, ])$data
#train <- data[sample, ] #Esta es la linea original
test  <- data[-sample, ]
